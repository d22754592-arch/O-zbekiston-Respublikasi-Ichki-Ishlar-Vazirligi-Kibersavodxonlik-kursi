        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-2">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold text-white leading-tight tracking-tight">
              {t('welcomeHeading1')} <span className="text-indigo-400">{t('welcomeHeadingHighlight')}</span> {t('welcomeHeading2')}
            </h2>
            ...
            <div className="grid grid-cols-3 gap-3 pt-2">
              <div className="bg-slate-900/50 rounded-2xl p-4 space-y-1">
                <div className="flex items-center space-x-2 text-indigo-400">
                  ...
                  <span className="text-base sm:text-lg font-bold text-white">{t('modulesCount')}</span>
                </div>
                <div className="text-xs text-slate-400 font-medium">{t('slidesCount')}</div>
              </div>
              <div className="bg-slate-900/50 rounded-2xl p-4 space-y-1">
                <div className="flex items-center space-x-2 text-emerald-400">
                  <CheckCircle2 className="w-4 h-4" />
                  <span className="text-base sm:text-lg font-bold text-white">{t('passingScore')}</span>
                </div>
                <div className="text-xs text-slate-400 font-medium">{t('passingScoreLabel')}</div>
              </div>
              <div className="bg-slate-900/50 rounded-2xl p-4 space-y-1">
                <div className="flex items-center space-x-2 text-amber-400">
                  <Award className="w-4 h-4" />
                  <span className="text-base sm:text-lg font-bold text-white">{t('certificateLabel')}</span>
                </div>
                <div className="text-xs text-slate-400 font-medium">{t('certificateDesc')}</div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5 bg-slate-900/60 rounded-3xl p-6 sm:p-7 space-y-5 shadow-xl">
            ...
            <div className="space-y-3">
              <label className="block text-xs font-medium text-slate-300 flex items-center space-x-1.5">
                ...
                <span>{t('fullNameInputLabel')} <span className="text-rose-400">*</span></span>
              </label>
